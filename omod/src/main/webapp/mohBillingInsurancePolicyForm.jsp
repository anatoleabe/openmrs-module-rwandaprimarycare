...
<openmrs:require privilege="Create Insurance Policy"
	otherwise="/login.htm"
	redirect="/module/rwandaprimarycare/insurancePolicy.form" />
...
<h2>
	<c:if test="${null ne param.patientId}">
		<spring:message code="rwandaprimarycare.insurance.policy.create" />
	</c:if>
	<c:if test="${null ne param.insurancePolicyId}">
		<spring:message code="rwandaprimarycare.insurance.policy.edit" />
	</c:if>
</h2>
